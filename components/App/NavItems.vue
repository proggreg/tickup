...
<template>
  <v-list>
    ...
    <v-list-item v-for="(list, i) in listsStore.lists" v-else :key="i" color="accent" fluid :value="i"
      placeholder="My List" @click="selectList(list)">
      <v-list-item-title :id="list.name">{{ list.name }}</v-list-item-title>
