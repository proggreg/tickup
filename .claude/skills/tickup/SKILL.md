...
3. for each subtask check if there is branch if there isn't create one and attach it to the task. 

4. execute: Based on description "Login fails with special chars"
   - Reproduce the issue
...
7 mark done: update_todo("507f1f77bcf86cd799439011", { status: "in review" })
```
